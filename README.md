...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1Tm8QeZE4a?p=157)


# 绪论
## 1.1 研究背景
当前社会各行业领域竞争压力非常大，随着当前时代的信息化，科学化发展，让社会各行业领域都争相使用新的信息技术，对行业内的各种相关数据进行科学化，规范化管理。这样的大环境让那些止步不前，不接受信息改革带来的信息技术的企业随时面临被淘汰，被取代的风险。所以当今，各个行业领域，不管是传统的教育行业，餐饮行业，还是旅游行业，医疗行业等领域都将使用新的信息技术进行信息革命，改变传统的纸质化，需要人手工处理工作事务的办公环境。软件信息技术能够覆盖社会各行业领域是时代的发展要求，各种数据以及文件真正实现电子化是信息社会发展的不可逆转的必然趋势。本旅客行李管理系统也是紧跟科学技术的发展，运用当今一流的软件技术实现软件系统的开发，让员工信息完全通过管理系统实现科学化，规范化，程序化管理。从而帮助信息管理者节省事务处理的时间，降低数据处理的错误率，对于基础数据的管理水平可以起到促进作用，也从一定程度上对随意的业务管理工作进行了避免，同时，旅客行李管理系统的数据库里面存储的各种动态信息，也为上层管理人员作出重大决策提供了大量的事实依据。总之，旅客行李管理系统是一款可以真正提升管理者的办公效率的软件系统。
## 1.2 目的和意义
信息数据的处理完全依赖人工进行操作，会耗费大量的人工成本，特别是面对大量的数据信息时，传统人工操作不仅不能对数据的出错率进行保证，还容易出现各种信息资源的低利用率与低安全性问题。更有甚者，耽误大量的宝贵时间，尤其是对信息的更新，归纳与统计更是耗财耗力的过程。所以电子化信息管理的出现就能缓解以及改变传统人工方式面临的处境，一方面可以确保信息数据在短时间被高效处理，还能节省人力成本，另一方面可以确保信息数据的安全性，可靠性，并可以实现信息数据的快速检索与修改操作，这些优点是之前的旧操作模式无法比拟的。因此旅客行李管理系统为数据信息的管理模式的升级与改革提供了重要的窗口。
## 1.3 论文结构安排
...
# 4 系统设计
旅客行李管理系统的设计方案比如功能框架的设计，比如数据库的设计的好坏也就决定了该系统在开发层面是否高效，以及在系统维护层面是否容易维护和升级，因为在系统实现阶段是需要考虑用户的所有需求，要是在设计阶段没有经过全方位考虑，那么系统实现的部分也就无从下手，所以系统设计部分也是至关重要的一个环节，只有根据用户需求进行细致全面的考虑，才有希望开发出功能健全稳定的程序软件。
## 4.1 系统概要设计
...
![C:\Users\Administrator\Desktop\img\lvkexingliguanlixitong\用户.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\lvkexingliguanlixitong\用户.jpg")
图4.1 用户实体属性图

（2）下图是工作人员投诉实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\lvkexingliguanlixitong\工作人员投诉.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\lvkexingliguanlixitong\工作人员投诉.jpg")
图4.2 工作人员投诉实体属性图

（3）下图是工作人员实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\lvkexingliguanlixitong\工作人员.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\lvkexingliguanlixitong\工作人员.jpg")
图4.3 工作人员实体属性图

（4）下图是建议实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\lvkexingliguanlixitong\建议.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\lvkexingliguanlixitong\建议.jpg")
图4.4 建议实体属性图

（5）下图是行李托运实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\lvkexingliguanlixitong\行李托运.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\lvkexingliguanlixitong\行李托运.jpg")
图4.5 行李托运实体属性图
### 4.3.2 数据库表结构设计
...
|3|jianyi\_uuid\_number|String|建议编号|是|
|4|jianyi\_name|String|建议标题|是|
|5|jianyi\_types|Integer|建议类型|是|
|6|jianyi\_content|String|建议内容|是|
|7|insert\_time|Date|建议时间|是|
|8|huifu\_text|String|回复内容|是|
|9|update\_time|Date|回复时间|是|
...
|5|tousu\_name|String|投诉标题|是|
|6|tousu\_types|Integer|投诉类型|是|
|7|tousu\_content|String|投诉内容|是|
|8|insert\_time|Date|投诉时间|是|
|9|chuli\_types|Integer|是否处理|是|
|10|chuli\_text|String|处理结果|是|
...
|1|Id|Int|id|否|
|2|yonghu\_id|Integer|用户|是|
|3|xingli\_uuid\_number|String|行李托运编号|是|
|4|xingli\_name|String|行李名称|是|
|5|xingli\_photo|String|行李照片|是|
|6|xingli\_types|Integer|行李类型|是|
|7|xingli\_zhongliang|BigDecimal|重量(公斤)|是|
|8|xingli\_zongjine|BigDecimal|总金额|是|
|9|xingli\_content|String|行李内物品清单|是|
|10|insert\_time|Date|申请时间|是|
|11|xingli\_zhuangtai\_types|Integer|行李状态|是|
|12|xingli\_yesno\_types|Integer|审核状态|是|
|13|xingli\_yesno\_text|String|审核意见|是|
|14|xingli\_shenhe\_time|Date|审核时间|是|
...
|7|gongzuorenyuan\_email|String|电子邮箱|是|
|8|create\_time|Date|创建时间|是|
表4.7管理员表
...
## 5.1 管理员功能介绍
### 5.1.1 行李托运管理
如图5.1显示的就是行李托运管理页面，此页面提供给管理员的功能有：查看行李托运列表,新增行李托运,修改行李托运,删除行李托运。

![](/md/blog.014.png)

图5.1 行李托运管理页面
### 5.1.2 投诉管理
如图5.2显示的就是投诉管理页面，此页面提供给管理员的功能有：新增投诉,修改投诉,删除投诉。

![](/md/blog.015.png)

图5.2 投诉管理页面
### 5.1.3 投诉类型管理
如图5.3显示的就是投诉类型管理页面，此页面提供给管理员的功能有：新增投诉类型,修改投诉类型,删除投诉类型。
